...
export class PollutionEngine {
  ...
  get_viewport_dark_sites(north, south, east, west, stride, max_bortle) {
    const ret = wasm.pollutionengine_get_viewport_dark_sites(
      this.__wbg_ptr,
      north,
      south,
      east,
  ...
  constructor(
    ...
    const ret = wasm.pollutionengine_new(
      ptr0,
      len0,
      width,
      height,
...
if (Symbol.dispose)
  PollutionEngine.prototype[Symbol.dispose] = PollutionEngine.prototype.free;
 ...
 * @returns {Float64Array}
 */
export function get_viewport_dark_sites(
  north,
  south,
  east,
  west,
  ...
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.get_viewport_dark_sites(
    north,
    south,
    east,
    west,
...
const PollutionEngineFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_pollutionengine_free(ptr, 1),
      );
