    ...
    <div className="space-y-12">
      <section className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          ...
          the night sky&apos;s brightness of a particular location. It
          quantifies the astronomical observability of celestial objects and the
      ...
      <section className="space-y-6">
        ...
        <div className="border-l-4 border-primary bg-primary/5 p-6 space-y-2">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Locations rated Bortle 3 or lower provide the high contrast needed
            for faint nebulosity and broadband imaging. In these zones, the
            "natural" sky background is dominant over artificial glow.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-2 border border-border/40 font-mono">
          <div className="grid grid-cols-[80px_1fr] border-b border-border/40 p-4 hover:bg-primary/5 transition-colors">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground">
                The Milky Way is so bright it casts shadows. Scorpius and
                Sagittarius cast diffuse light.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-[80px_1fr] border-b border-border/40 p-4 hover:bg-primary/5 transition-colors">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground">
                Some light pollution is evident along the horizon. The Milky Way
          ...
          <div className="grid grid-cols-[80px_1fr] border-b border-border/40 p-4 hover:bg-primary/5 transition-colors">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground">
                The Milky Way is very weak or invisible near the horizon. Light
                domes are visible in several directions.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-[80px_1fr] p-4 hover:bg-primary/5 transition-colors">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground">
                Only the brightest stars, planets, and the Moon are visible.
      ...
      <section className="space-y-6">
        ...
        <div className="p-8 border border-border/40 bg-muted/30">
          <p className="text-sm leading-loose">
            For every step up the Bortle scale, the background sky brightness
            increases significantly. In a{" "}
            <span className="font-bold">Bortle 1</span> site, you can shoot
            5-minute sub-exposures without blowing out the histogram. In{" "}
            <span className="font-bold text-red-500">Bortle 9</span>, your
            sensor will be saturated in less than 20 seconds.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <ul className="list-none space-y-4 text-sm">
          <li className="flex gap-4">
            ...
            <span>
              <strong>Filters:</strong> If you are stuck in Bortle 6+, use
              Narrowband (H-alpha, OIII, SII) or Duo-band filters to cut through
              the sodium and LED light domes.
            </span>
          </li>
          <li className="flex gap-4">
            <span className="text-primary font-bold">»</span>
            <span>
              <strong>Distance:</strong> Traveling just 30-40 minutes away from
              a city can often drop you 2 classes on the Bortle scale, doubling
