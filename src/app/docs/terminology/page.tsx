    ...
    <div className="space-y-12">
      <section className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          A quick reference guide for astronomical and technical terms used
          within the Vyoma interface.
        </p>
      </section>
        ...
        <div className="grid gap-4 border border-border/40 p-6">
          <div className="space-y-1">
            ...
            <p className="text-xs leading-relaxed">
              The angle of a celestial object above the observer&apos;s horizon.
              0° is the horizon, and 90° is the zenith (directly overhead).
            </p>
          </div>
          <div className="space-y-1">
            <h3 className="font-bold text-sm uppercase text-primary">
            ...
            <p className="text-xs leading-relaxed">
              The compass direction of a celestial object, measured in degrees
              clockwise from North (0°). East is 90°, South is 180°, and West is
              270°.
            </p>
          </div>
          <div className="space-y-1">
            ...
            <p className="text-xs leading-relaxed">
              Calculations performed relative to the observer&apos;s specific
              position on the surface of the Earth, accounting for parallax.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-2 border-l border-border/40 pl-4">
            ...
            <p className="text-xs text-muted-foreground">
              The celestial equivalent of longitude. It measures the distance
          ...
          <div className="space-y-2 border-l border-border/40 pl-4">
            ...
            <p className="text-xs text-muted-foreground">
              The celestial equivalent of latitude. It measures the angle north
          ...
          <div className="space-y-2 border-l border-border/40 pl-4">
            ...
            <p className="text-xs text-muted-foreground">
              Vyoma performs internal calculations using Julian Dates to ensure
              high-precision temporal alignment across millennia.
            </p>
          </div>
          <div className="space-y-2 border-l border-border/40 pl-4">
            <h3 className="font-bold text-sm uppercase">Zenith</h3>
            <p className="text-xs text-muted-foreground">
              The point in the sky directly above the observer. In Vyoma,
              objects reaching high altitudes near the zenith are ideal for
              imaging.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <p className="text-xs leading-loose text-muted-foreground">
                <strong>Signal-to-Noise Ratio:</strong> A measure of how much
                useful information (light from stars/nebulae) you have compared
                to unwanted noise (light pollution, sensor heat).
              </p>
            </div>
            <div className="flex items-start gap-4">
              <span className="text-primary font-black">SQM</span>
              <p className="text-xs leading-loose text-muted-foreground">
                <strong>Sky Quality Meter:</strong> An instrument used to
                measure the luminance of the night sky in magnitudes per square
                arcsecond.
              </p>
            </div>
          </div>
